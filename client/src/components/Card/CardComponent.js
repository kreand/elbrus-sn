...
const CardComponent = ({ id, title, justify, width, margin, cover, buyCallback, deleteCallback, description }) => {
  return (
    <Row justify={justify || 'center'}>
      <Col>
        <Card
          ...
          cover={<img alt="your_img"
                      src={cover || 'https://gw.alipayobjects.com/zos/rmsportal/JiqGstEfoWAOHiTxclqi.png'}/>}
          actions={[
